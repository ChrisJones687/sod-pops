...
sod_eu1_sim_treatment <- data.frame(model = rep("actual", 8), year = seq(2015, 2022, 1), strain = rep("eu1",8), treatment = rep("YES", 8), mean_inf = rep(1, 8), sd_inf = rep(0, 8), mean_area = rep(1, 8), sd_area = rep(0, 8))
...
parameter_means[1] <- parameter_means[1]*.9
...
treatments_file <- ffIn("Treatments/manage_2016.tif")
...
sod_eu1_sim_treatment$mean_inf[sod_eu1_sim_treatment$year == 2016] <- eu1_2016_mr$number_infecteds[1]
sod_eu1_sim_treatment$sd_inf[sod_eu1_sim_treatment$year == 2016] <- eu1_2016_mr$number_infecteds[2]
sod_eu1_sim_treatment$mean_area[sod_eu1_sim_treatment$year == 2016] <- eu1_2016_mr$infected_areas[1]
sod_eu1_sim_treatment$sd_area[sod_eu1_sim_treatment$year == 2016] <- eu1_2016_mr$infected_areas[2]
...
treatments_file <- ffIn("Treatments/manage_2017.tif")
...
sod_eu1_sim_treatment$mean_inf[sod_eu1_sim_treatment$year == 2017] <- eu1_2017_mr$number_infecteds[1]
sod_eu1_sim_treatment$sd_inf[sod_eu1_sim_treatment$year == 2017] <- eu1_2017_mr$number_infecteds[2]
sod_eu1_sim_treatment$mean_area[sod_eu1_sim_treatment$year == 2017] <- eu1_2017_mr$infected_areas[1]
sod_eu1_sim_treatment$sd_area[sod_eu1_sim_treatment$year == 2017] <- eu1_2017_mr$infected_areas[2]
...
treatments_file <- ffIn("Treatments/manage_2018.tif")
use_initial_condition_uncertainty <- TRUE
# 
...
sum(values(eu1_2018_mr$simulation_sd))
sod_eu1_sim_treatment$mean_inf[sod_eu1_sim_treatment$year == 2018] <- eu1_2018_mr$number_infecteds[1]
sod_eu1_sim_treatment$sd_inf[sod_eu1_sim_treatment$year == 2018] <- eu1_2018_mr$number_infecteds[2]
sod_eu1_sim_treatment$mean_area[sod_eu1_sim_treatment$year == 2018] <- eu1_2018_mr$infected_areas[1]
sod_eu1_sim_treatment$sd_area[sod_eu1_sim_treatment$year == 2018] <- eu1_2018_mr$infected_areas[2]

sim_inf_eu1_2018 <- c(eu1_2018_mr$simulation_mean, eu1_2018_mr$simulation_sd / 3)
...
use_initial_condition_uncertainty <- TRUE
treatments_file <- ffIn("Treatments/manage_2019.tif")
...
sum(values(eu1_2019_mr$simulation_sd))
sod_eu1_sim_treatment$mean_inf[sod_eu1_sim_treatment$year == 2019] <- eu1_2019_mr$number_infecteds[1]
sod_eu1_sim_treatment$sd_inf[sod_eu1_sim_treatment$year == 2019] <- eu1_2019_mr$number_infecteds[2]
sod_eu1_sim_treatment$mean_area[sod_eu1_sim_treatment$year == 2019] <- eu1_2019_mr$infected_areas[1]
sod_eu1_sim_treatment$sd_area[sod_eu1_sim_treatment$year == 2019] <- eu1_2019_mr$infected_areas[2]
...
treatments_file <- ffIn("Treatments/manage_2020.tif")
...
sum(values(eu1_2020_mr$simulation_mean))
...
sod_eu1_sim_treatment$mean_inf[sod_eu1_sim_treatment$year == 2020] <- eu1_2020_mr$number_infecteds[1]
sod_eu1_sim_treatment$sd_inf[sod_eu1_sim_treatment$year == 2020] <- eu1_2020_mr$number_infecteds[2]
sod_eu1_sim_treatment$mean_area[sod_eu1_sim_treatment$year == 2020] <- eu1_2020_mr$infected_areas[1]
sod_eu1_sim_treatment$sd_area[sod_eu1_sim_treatment$year == 2020] <- eu1_2020_mr$infected_areas[2]
...
treatments_file <- ffIn("Treatments/manage_2021.tif")
...
sum(values(eu1_2021_mr$simulation_mean))
sod_eu1_sim_treatment$mean_inf[sod_eu1_sim_treatment$year == 2021] <- eu1_2021_mr$number_infecteds[1]
sod_eu1_sim_treatment$sd_inf[sod_eu1_sim_treatment$year == 2021] <- eu1_2021_mr$number_infecteds[2]
sod_eu1_sim_treatment$mean_area[sod_eu1_sim_treatment$year == 2021] <- eu1_2021_mr$infected_areas[1]
sod_eu1_sim_treatment$sd_area[sod_eu1_sim_treatment$year == 2021] <- eu1_2021_mr$infected_areas[2]
